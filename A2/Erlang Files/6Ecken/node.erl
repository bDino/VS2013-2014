            ...
            %% if Branch == Core 
                ...
                case IBNeighbour == Neighbour of
                    ...
                    false ->
                        ...
                        NewNodeState = report_procedure(NewFindCount, TestEdge, NewNodeState, NewBestWeight, InBranch, NodeName),
                end,
